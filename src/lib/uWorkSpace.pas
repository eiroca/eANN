...
uses
  eLibMath, eANN, eDataPick, SysUtils, Classes, Controls;
...
function TWorkSpace.MakeNetwork(NetClass: TANNClass): TComponent;
var
  Name: string;
begin
...
procedure TWorkSpace.NotifyANNChange(Sender: TANN);
begin
  FChanged:= true;
end;
